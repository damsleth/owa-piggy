...
def _token_response(
    make_jwt, *, tid="tenant-uuid", upn="user@example.org", refresh_token="1.AQfake"
):
...
def test_silent_timeout_before_session_does_not_blame_the_tenant(monkeypatch, tmp_path, capsys):
