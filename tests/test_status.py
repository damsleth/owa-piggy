...
def test_status_google_profile_shows_no_hard_cap(monkeypatch, tmp_config, clean_env, capsys):
    ...
    monkeypatch.setattr(
        ...
        lambda cid, secret, rt: {"access_token": "ya29.a0-opaque-not-a-jwt", "expires_in": 3600},
    )
    monkeypatch.setattr(status_mod, "launchd_is_scheduled", lambda _alias: False)
